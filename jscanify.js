      ...
      highlightPaper(image, options) {
        ...
        if (maxContour) {
          ...
          if (
            ...
            ctx.closePath();
            this.drawCorner(ctx, topLeftCorner);
            this.drawCorner(ctx, topRightCorner);
            this.drawCorner(ctx, bottomLeftCorner);
            this.drawCorner(ctx, bottomRightCorner);
          }
        }
